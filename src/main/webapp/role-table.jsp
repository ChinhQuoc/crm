		...
		<div class="navbar-default sidebar" role="navigation">
			<div class="sidebar-nav navbar-collapse slimscrollsidebar">
				<ul class="nav" id="side-menu">
					<li><a href=<c:url value="/" /> class="waves-effect"><i 
									...
									<tbody>
										<c:choose>
											<c:when test="${listRole == null}">
												<tr>
													<td colspan="4">Không có role nào</td>
												</tr>
											</c:when>
											<c:otherwise>
												<c:forEach var="item" items="${listRole}" varStatus="position">
													<tr>
														...
														<td>
															...
															<a id-role="${item.id}" class="btn btn-sm btn-danger btn-xoa">Xóa</a>
														</td>
													</tr>
												</c:forEach>
											</c:otherwise>
